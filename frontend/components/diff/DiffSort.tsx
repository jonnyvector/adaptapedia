    ...
    <div className="flex items-center gap-2">
      ...
      <div className="relative">
        <select
          ...
          className={`pl-3 pr-10 ${TEXT.body} bg-white dark:bg-black text-black dark:text-white border ${BORDERS.medium} ${RADIUS.control} focus:outline-none focus:border-black focus:dark:border-white h-[40px] cursor-pointer appearance-none w-full box-border font-bold`}
