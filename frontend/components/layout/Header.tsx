        ...
        <div className="flex items-center justify-between py-2 gap-2 sm:gap-3">
          ...
          <nav className="flex items-center gap-1" style={{ alignItems: 'center' }}>
            ...
            {!mounted ? (
              ...
              <Link
                href="/auth/login"
                className={`px-2 py-1 sm:px-3 sm:py-1.5 border ${BORDERS.solid} bg-black dark:bg-white text-white dark:text-black hover:bg-white hover:dark:bg-black hover:text-black hover:dark:text-white font-bold transition-all ${TEXT.label} rounded-md ${monoUppercase} flex items-center`}
